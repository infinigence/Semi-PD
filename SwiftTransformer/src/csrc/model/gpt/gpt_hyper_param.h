...
struct GptHyperParam {
	...
	bool is_rotary_posi_embedding_scaling = false;
	int64_t factor = 8;
    int64_t low_freq_factor = 1;
    int64_t high_freq_factor = 4;
	...
	static GptHyperParam GetLlama2HyperParam (
		...
		int64_t head_dim,
		int64_t ffn_inter_dim,
		bool is_rotary_posi_embedding_scaling
	) {
		return GptHyperParam{
			.vocab_size = vocab_size,
			.max_position_embeddings = max_position_embeddings,
			...
			.is_rotary_posi_embedding_scaling = is_rotary_posi_embedding_scaling,
			.is_gated_ffn = true,
